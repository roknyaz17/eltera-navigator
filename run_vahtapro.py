...
Запуск:
    .venv\\Scripts\\python.exe run_vahtapro.py
    .venv\\Scripts\\python.exe run_vahtapro.py --reset
    .venv\\Scripts\\python.exe run_vahtapro.py --check-only --limit 10
"""
...
def main() -> None:
    ...
    if args.check_only:
        ...
        asyncio.run(run_pipeline(["vahtapro"], reset=args.reset))
